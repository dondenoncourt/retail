...
public class WriteDataQueue {
	...
	public boolean write(String readFromDatqQueueName, CreditCardPreAuth ccPreAuth,
			String clientUserId, String clientUserPassword, String paywareTerminal) {
		boolean error = false;
		try {
			setFields(readFromDatqQueueName, ccPreAuth, clientUserId, clientUserPassword, paywareTerminal);
	...
	private void setFields(String readFromDatqQueueName, CreditCardPreAuth ccPreAuth,
		...
		dqRec.setField("RCLIEN", paywareTerminal); // "100010001");
