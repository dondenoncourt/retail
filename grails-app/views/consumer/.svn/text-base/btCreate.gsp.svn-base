...
<html>
    ...
    <body>
        <div   id="yourAccountContent">
            ...
            <br clear="left" />
            <h2>Bill Tos:</h2>
          <g:form name="billToAdd" action="btSave">
              ...
              <br clear="left" />
              <div class="inputBox ${hasErrors(bean:billTo,field:'city','errors')}"><g:textField name="city" value="${billTo.city}" size="13"  maxlength="20" /><span class="required">*</span></div>
              ...
              <div class="inputBox ${hasErrors(bean:billTo,field:'zipCode','errors')}"><g:textField name="zipCode" value="${billTo.zipCode}" size="9" maxlength="10" /><span class="required">*</span></div>
              <br/><br/>
              <div>
            ...
            <div class="buttons">
                ...
                <g:submitButton name="create" value="Add" class="clickme" />
            </div>
          </g:form>
        </div>
		<g:javascript>
