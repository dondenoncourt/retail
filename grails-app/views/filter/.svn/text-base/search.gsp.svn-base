    ...
    <g:if test="${haveResults}">
      <div class="results">
        <g:each var="result" in="${searchResult.results}" status="index">
          <div class="result">
            ${result.itemNo}:${result.desc.encodeAsHTML()}<br/>
            Searched field values: itemNo: ${result.itemNo} altItemNo: ${result.altItemNo} substituteItemNo: ${result.substituteItemNo} 
            desc: ${result.desc} color: ${result.color} countryOfOrigin: ${result.countryOfOrigin} altItemNo: ${result.altItemNo} 
            shortName: ${result.shortName}
            yearAdded: ${result.yearAdded} taxableCode: ${result.taxableCode}
          </div>
        </g:each>
      </div>
      ...
      <div>
        <div class="paging">
          <g:if test="${haveResults}">
              ...
              <g:else><g:paginate controller="filter" action="search" params="[q: params.q]" total="${searchResult.total}" prev="&lt; previous" next="next &gt;"/></g:else>
          </g:if>
        </div>
      </div>
    </g:if>
