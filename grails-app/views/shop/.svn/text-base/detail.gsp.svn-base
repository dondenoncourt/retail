                                ...
                                <% if (item.retailPrice) { %>
                                       <% if (item.isWebAvailable(item)) { %>
											<dl id="framesizeQty">
												...
												<% } else if (patioColors) { %>
													<dt class="dtPrice">Color:</dt>
													<dd class="ddPriceValue">
												...
												<div>
													...
													<dd class="ddPriceValue">
														<g:textField name="quantity" class="number" value="${cmd?.quantity?:item.minQty}" tabindex="1"/>
													</dd>
                                            ...
                                            <dl>
                                                <% if (item.specialPrice) { %>
                                                    <dt class="dtPrice">MSRP:</dt>
                                                    <dd class="crossout ddPriceValue">
                                                        <span class="crossoutnot">
                                                            <g:formatNumber number="${item.msrp}" type="currency" currencySymbol="\$" />
                                                        </span>
                                                    </dd>
                                                    <dt class="important dtPrice">Special Price:</dt>
                                                    <dd class="important ddPriceValue"><g:formatNumber number="${item.specialPrice}" type="currency" currencySymbol="\$" /></dd>
                                                <% } else { %>
