...
<head> 
	...
	<link href="${createLinkTo(dir:'css',file:'toys.css')}" rel="stylesheet" type="text/css" />
...
<div id="container"> 
    <div id="header"> 
        <g:render template='/layouts/cartMenuLogo' model="${[division:'toys']}"/>
        <div class="navSecond"> 
		    <g:render template='/layouts/toysCategories' />
		    <g:render template='/layouts/socialMedia' />
			<div class="clearBoth"></div>
        </div> 
    </div> 
    <g:render template='/layouts/mainFooter' model="${[currentDivision:'toys']}"/>
</div> 
