...
<div id="container"> 
    <div id="header"> 
        <g:render template='/layouts/cartMenuLogo' model="${[division:'patio']}"/>
        <div class="navSecond"> 
		    <g:render template='/layouts/patioCategories' />
		    <g:render template='/layouts/socialMedia' />
			<div class="clearBoth"></div>
        </div> 
    </div> 
    <g:render template="/layouts/mainFooter" model="${[currentDivision:'patio', params:params]}"/>
